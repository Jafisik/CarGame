...
public class PrometeoCarController : MonoBehaviour
{
    ...
    public bool useUI = CheckBox.carSpeedOn;
    ...
    void Start()
    {
      ...
      RRwheelFriction = new WheelFrictionCurve ();
        ...
        if(CheckBox.carSpeedOn){
            carSpeedText.enabled = true;
          InvokeRepeating("CarSpeedUI", 0f, 0.1f);
        }else if(!CheckBox.carSpeedOn)
        {
          if(carSpeedText != null){
            carSpeedText.text = "0";
          }
            carSpeedText.enabled = false;
        }
    ...
    public void TurnTowardsDirection(Transform targetObject, bool reverse)
    {
        ...
        // Apply the steering angle to the colliders
        frontLeftCollider.steerAngle = Mathf.Lerp(frontLeftCollider.steerAngle, angleToTarget, steeringSpeed);
        frontRightCollider.steerAngle = Mathf.Lerp(frontRightCollider.steerAngle, angleToTarget, steeringSpeed);
    }
    ...
    public void RecoverTraction(){
      isTractionLocked = false;
        driftingAxis = 0;//driftingAxis - (Time.deltaTime / 1.5f);
      if(driftingAxis < 0f){
        driftingAxis = 0f;
      }
